 ...
 * DAO mixins.
 * // XXX(kev): In future versions, this will not maintain a strict 1:1 relationship
...
/**
 * XXX(kev) Deprecate/remove this for LB 4.0?
...
/**
 * XXX(kev): Deprecate this for LB 4.x?
 ...
 * XXX(kev): Raymond, can you give example of what behavior(s) are typically
 ...
 * XXX(kev): Why is this not Promisified like the connect function?
 ...
 * XXX(kev): What is "obj" supposed to represent?
 * @param {Object} obj  ?
 * @param {Object} args  ?
 */
 ...
 * XXX(kev): Why is a hidden property not writable or enumerable? What
